            ...
            <div class="row pl-4">
                <div class="px-0 col-md-9">
                 ...
                 <div class="col-md-12 pt-4">
                  ...
                  <form method="POST" action="{{route('solicitud.updateDocs')}}"  enctype="multipart/form-data" id="myForm">
                     @csrf
                    ...
                    <div class="card govco-card animate__animated animate__bounceInRight">
                        ...
                        <label>Nombre del solicitante</label>
                         <input type="text" class="form-control" value="{{$solicitud->nom_responsable}} {{$solicitud->ape_responsable}}" readonly>
                       </div>
                       </div>
                       ...
                       <div class="col-md-12">
                        ...
                        <div class="col-md-6">  
                        <div class="form-group">
                        <label>Copia documento de identidad/certificado</label>
                        <div class="file-loading">
                        <input class="" id="archivo_documento" accept="application/pdf" name="adjunto_documentoIdentidad" type="file" data-overwrite-initial="true">       </div>                         
                       </div>
                       </div>
                       ...
                       <div class="col-md-6">  
                        ...
                        <div class="file-loading">
                        <input class="" id="archivo_poder" accept="application/pdf" name="adjunto_poder" type="file" data-overwrite-initial="true"> 
                        </div>                         
                       </div>
                       </div>
                       ...
                       <div class="col-md-6">  
                        ...
                        <div class="file-loading">
                        <input class="" id="archivo_descripcion" accept="application/pdf" name="adjunto_descripcion" type="file" data-overwrite-initial="true"> 
                        </div>                         
                       </div>
                       </div>
                        ...
                        <div class="col-md-6">  
                        <div class="form-group">
                        <label>Planos del proyecto</label>
                        <div class="file-loading">
                        <input class="" id="archivo_planos" accept="application/pdf" name="adjunto_planos" type="file" data-overwrite-initial="true"> 
                        </div>                         
                       </div>
                       </div>
