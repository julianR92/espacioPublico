...
<div class="container mt-3 mb-4 m-xs-x-3">
    ...
    <div class="container-fluid">
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <button style="font-size:15px;" type="button" class="btn btn-round btn-middle" name="consultar"><a href="{{URL::route('solicitud.finalizar')}}">Finalizar</a></button>
...
<script>
    setTimeout(function() {
      window.location.href = '/solicitud/finalizar';
   }, 120000);
</script>
@else
